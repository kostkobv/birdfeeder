...
// GSMEscapeSymbol to use symbols from extended chars table
const GSMEscapeSymbol byte = 0x1B

// GSMCRSymbol carriage return to fill the rest of empty bits in the octets
const GSMCRSymbol byte = 0x0D

// EmptyOctet to fill the
const EmptyOctet byte = 0x00

// GSMTable is a semantic interface to keep symbols map
type GSMTable map[rune]byte

// TwoCharGSMSymbols is a map of symbols that take 2 spaces in regular 7-bit GSM SMS. Should be escaped by GSMEscapeSymbol at the beginning
var TwoCharGSMSymbols = GSMTable{
...
// OneCharGSMSymbols is a map of symbols that take 1 space in regular 7-bit GSM SMS.
var OneCharGSMSymbols = GSMTable{
